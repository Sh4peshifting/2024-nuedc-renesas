...
#include "bsp_api.h"
                ...
                #include "task.h"
                #include "semphr.h"
                extern void led1_create(void);
                extern TaskHandle_t led1;
extern void usartprocess_create(void);
                extern TaskHandle_t usartprocess;
extern void interface_create(void);
                extern TaskHandle_t interface;
extern void motion_create(void);
                extern TaskHandle_t motion;
extern void hmi_create(void);
                extern TaskHandle_t hmi;
extern void working_create(void);
                extern TaskHandle_t working;
