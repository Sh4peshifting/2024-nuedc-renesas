...
#define RS522_RST(N) R_IOPORT_PinWrite(&g_ioport_ctrl, RC522_RST, N==1?BSP_IO_LEVEL_HIGH:BSP_IO_LEVEL_LOW)
#define RS522_NSS(N) R_IOPORT_PinWrite(&g_ioport_ctrl, RC522_CS, N==1?BSP_IO_LEVEL_HIGH:BSP_IO_LEVEL_LOW)
